...
const Member = (props) => {
  return (
    <div className="member">
      <div className="member__card__border"></div>
      <div className="member__card">
        <div className="member__card__image">
          <img
            className="member__card__image__img"
            src={props.imgSrc}
            alt="profile_pic"
            draggable="false"
          />
        ...
        <div className="member__card__details">
          ...
          <div className="member__card__links">
            <a
              href={
                props.linkedIn.includes("https://") |
                props.linkedIn.includes("www")
                  ? props.linkedIn
                  : "https://" + props.linkedIn
              }
              target="_blank"
              rel="noreferrer"
            >
              <span className="fa fa-linkedin member__card__links__linkedin"></span>
            </a>
          </div>
        </div>
      </div>
